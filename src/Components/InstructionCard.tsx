...
const InstructionCard = (props:InstructionCardProps):JSX.Element => { //maybe return jsx instead
    ...
    const showDescriptionById = (id:number):string => {
        switch(id){
            ...
            case 3: {
                return "All bids must be entered by the end of the auction on November 18 at 9:00PM. At the end of the dinner, you will be contacted to receive and pay for your item."
            }
            default: {
